...
// the same occurrence always maps to the same key, which keeps the CalImport
// upsert idempotent across re-imports and re-exports, while distinct occurrences
// of the same series map to distinct events in the target calendar.
